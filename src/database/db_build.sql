BEGIN;
    DROP TABLE IF EXISTS users,articles,bookings,services,schedule,users CASCADE;
CREATE TABLE services(
  ...
  CREATE TABLE users(user_id SERIAL PRIMARY KEY,name VARCHAR(50) NOT NULL,email VARCHAR(50) UNIQUE NOT NULL, password VARCHAR(200) NOT NULL);
...
INSERT INTO bookings (booking_date,booking_time,customer_name,customer_phone,service_id) VALUES ('20191124','0900','ghj@g.com ','Itay','0544791675',1);
 INSERT INTO schedule(day,start_time,end_time) VALUES(0,"0900","1300"),(0,"1400","2100"),(1,"0900","2100"),(2,"0900","1600")(3,"0900","2100"),(4,"0900","2100"),(5,"0900","1600");
   INSERT INTO users
    (name,email,password)
  VALUES
    ('theAdmin', 'theAdmin@gmail.com', '$2a$10$jaE1jYP32AEiEqbLQpyCBuCfLcXyqfmzNZHt5rUptz5xoRxW/RbgG');
